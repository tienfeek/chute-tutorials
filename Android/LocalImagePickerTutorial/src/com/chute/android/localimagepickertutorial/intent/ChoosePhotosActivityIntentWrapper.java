package com.chute.android.localimagepickertutorial.intent;

import java.util.ArrayList;

import com.chute.android.localimagepickertutorial.app.LocalImagePickerTutorialActivity;
...
public class ChoosePhotosActivityIntentWrapper {
	...
	super();
	intent = new Intent(packageContext, LocalImagePickerTutorialActivity.class);
    }
