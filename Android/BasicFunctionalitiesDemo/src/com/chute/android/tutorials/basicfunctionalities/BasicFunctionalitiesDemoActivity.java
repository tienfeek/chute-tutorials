...
public class BasicFunctionalitiesDemoActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		 ...
		 * the static classes: GCChutes GCAssets GCComments GCHearts
		 * GCMembership etc... Each of these classes are located inside specific
		 * packages inside the api package in the chute sdk project.
		 * 
		 ...
		 * 
		 * Each call can be executed with a default parser that returns a
		 * chute-specific object or a custom one by adding a custom object
		 * implementing GCHttpResponseParser.
		 * 
		 * The callback has 4 methods. One of those methods will be called
	...
	private final class GCChutesAllCallback implements
